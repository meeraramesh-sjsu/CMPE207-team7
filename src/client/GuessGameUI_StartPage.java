...
public class GuessGameUI_StartPage extends javax.swing.JFrame {

    
    /** Creates new form HangmanUI1 */
    public GuessGameUI_StartPage() {
        initComponents();
...
(this).setVisible(false);
    java.awt.EventQueue.invokeLater(new Runnable() {
        ...
        public void run() {
                try {
                    GuessGameUI_PPage hangman2=null;
                    try {
                        hangman2 = new GuessGameUI_PPage(input_host.getText(),Integer.parseInt(input_port.getText()));
                    } catch (UnknownHostException ex) {
                        Logger.getLogger(GuessGameUI_StartPage.class.getName()).log(Level.SEVERE, null, ex);
...
private void startMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_startMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new GuessGameUI_StartPage().setVisible(true);
            }
        });
    }
