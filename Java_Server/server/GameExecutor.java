...
public class GameExecutor extends Thread implements Serializable {
    ...
    GameExecutor(Socket s, String filename) {
        System.out.print("Server GameExecutor called");
            //thread constructor
            file = new Textfile();
            ...
            try {
                ...
                Logger.getLogger(GameExecutor.class.getName()).log(Level.SEVERE, null, ex);
            }
            System.out.println("Chosenword= "+chosenword);
            String image_Name="/home/ubuntu/Server/Java_Server/server/images/" + chosenword + ".jpeg";
    ...
    public void run() {
        try {
            ...
            while (running) {
                ...
                GameResult game = new GameResult();//creates the game class that implements the 4pic1word cases
		    ...
		    else if (((Client2Server) clientObj).getaction() == 4) {
                    	game.getHint(chosenword, clientdata);
                    }
                }
